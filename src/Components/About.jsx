 ...
 */
const skillsList = ["Statistician", "Data Insight and Visualisations", "AI Assistant Builder"];
 ...
 */
const detailOrQuote =
  "I love using modern data techniques to tackle complex business challenges. Particularly using Machine Learning and the latest technologies to transform our world.";
